...
public final class EnrichedNetherrack extends PylonBlock implements PylonTickingBlock {
    ...
    public EnrichedNetherrack(@NotNull PylonBlockSchema schema, @NotNull Block block, @NotNull BlockCreateContext context) {
        super(schema, block, context);
    }

    @SuppressWarnings("unused")
    public EnrichedNetherrack(@NotNull PylonBlockSchema schema, @NotNull Block block, @NotNull PersistentDataContainer pdc) {
