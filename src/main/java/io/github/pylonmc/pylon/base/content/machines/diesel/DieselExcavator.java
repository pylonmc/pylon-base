...
public class DieselExcavator extends Excavator implements
        PylonTickingBlock,
    ...
    public DieselExcavator(@NotNull Block block, @NotNull BlockCreateContext context) {
        super(block, context);
    ...
    @SuppressWarnings("unused")
    public DieselExcavator(@NotNull Block block, @NotNull PersistentDataContainer pdc) {
        super(block, pdc);
    }
