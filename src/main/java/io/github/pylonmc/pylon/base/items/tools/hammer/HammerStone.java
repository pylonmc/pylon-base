...
public class HammerStone extends Hammer {

    public static final NamespacedKey KEY = pylonKey("hammer_stone");

    public static final Material TOOL_MATERIAL = Material.STONE_PICKAXE;
    public static final Material BASE_BLOCK = Material.STONE;
    public static final MiningLevel MINING_LEVEL = MiningLevel.STONE;
    ...
    public static final ItemStack ITEM_STACK = createItemStack(KEY, TOOL_MATERIAL, (1.0 / 3) - 4, 1, 1);

    public HammerStone(@NotNull PylonItemSchema schema, @NotNull ItemStack stack) {
        super(schema, stack);
    }
