    ...
    public static final BeheadingSword BEHEADING_SWORD = new BeheadingSword(
            ...
            new ItemStackBuilder(Material.DIAMOND_SWORD)
                    ...
                    .lore(new LoreBuilder()
                            ...
                            .attributeLine("Normal entity", "players, creepers, piglins,", Quantity.NONE)
                            .text("<white>ender dragons, skeletons and zombies").newline()
                            .attributeLine("Normal entity head drop chance", "15", Quantity.PERCENT)
                            .attributeLine("Wither Skeleton head drop chance", "5", Quantity.PERCENT))
                    .set(DataComponentTypes.ENCHANTMENT_GLINT_OVERRIDE, true)
                    .set(DataComponentTypes.MAX_DAMAGE, 300)
                    .build()
    );
