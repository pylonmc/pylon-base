...
public final class PylonItems {
    ...
    public static final NamespacedKey STRUCTURE_LOCATOR_DESERT_PYRAMID_KEY = pylonKey("structure_locator_desert_pyramid");
    public static final ItemStack STRUCTURE_LOCATOR_DESERT_PYRAMID_STACK = ItemStackBuilder.pylonItem(Material.COMPASS, STRUCTURE_LOCATOR_DESERT_PYRAMID_KEY).build();

    static {
        PylonItem.register(StructureLocator.class, STRUCTURE_LOCATOR_DESERT_PYRAMID_STACK);
        ShapedRecipe recipe = new ShapedRecipe(pylonKey("structure_locator_desert_pyramid"), STRUCTURE_LOCATOR_DESERT_PYRAMID_STACK);
        recipe.shape(
                "GGG",
                "DAD",
                "DDD"
        ...
        recipe.setIngredient('D', SHIMMER_DUST_2);
        recipe.setCategory(CraftingBookCategory.MISC);
        RecipeTypes.VANILLA_CRAFTING.addRecipe(recipe);
    }

    public static final NamespacedKey STRUCTURE_LOCATOR_NETHER_FORTRESS_KEY = pylonKey("structure_locator_nether_fortress");
    public static final ItemStack STRUCTURE_LOCATOR_NETHER_FORTRESS_STACK = ItemStackBuilder.pylonItem(Material.COMPASS, STRUCTURE_LOCATOR_NETHER_FORTRESS_KEY).build();

    static {
        PylonItem.register(StructureLocator.class, STRUCTURE_LOCATOR_NETHER_FORTRESS_STACK);
        ShapedRecipe recipe = new ShapedRecipe(pylonKey("structure_locator_nether_fortress"), STRUCTURE_LOCATOR_NETHER_FORTRESS_STACK);
        recipe.shape(
                "DDD",
                "SSS",
                "DDD"
