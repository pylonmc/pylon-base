...
public class BaseKeys {
    ...
    public static final NamespacedKey GOLD_DUST = baseKey("gold_dust");
    public static final NamespacedKey CRUSHED_RAW_GOLD = baseKey("crushed_raw_gold");

    public static final NamespacedKey IRON_DUST = baseKey("iron_dust");
    public static final NamespacedKey CRUSHED_RAW_IRON = baseKey("crushed_raw_iron");

    public static final NamespacedKey QUARTZ_DUST = baseKey("quartz_dust");

    public static final NamespacedKey DIAMOND_DUST = baseKey("diamond_dust");
    ...
    public static final NamespacedKey SHIMMER_DUST_2 = baseKey("shimmer_dust_2");
    ...
    public static final NamespacedKey WATER_DRAINER = baseKey("water_drainer");
    public static final NamespacedKey LAVA_DRAINER = baseKey("lava_drainer");

    public static final NamespacedKey FLUID_STRAINER = baseKey("fluid_strainer");
    ...
    public static final NamespacedKey SMELTERY_HOPPER = baseKey("smeltery_hopper");
    ...
    public static final NamespacedKey PIT_KILN_DISPLAY = baseKey("pit_kiln_display");
    ...
    public static final NamespacedKey ELEVATOR_1 = baseKey("elevator_1");
    public static final NamespacedKey ELEVATOR_2 = baseKey("elevator_2");
    public static final NamespacedKey ELEVATOR_3 = baseKey("elevator_3");

    public static final NamespacedKey HYDRAULIC_GRINDSTONE_TURNER = baseKey("hydraulic_grindstone_turner");
    ...
    public static final NamespacedKey PURIFICATION_TOWER_CAP = baseKey("purification_tower_cap");

    public static final NamespacedKey SOLAR_PURIFICATION_TOWER_1 = baseKey("solar_purification_tower_1");
    public static final NamespacedKey SOLAR_PURIFICATION_TOWER_2 = baseKey("solar_purification_tower_2");
    public static final NamespacedKey SOLAR_PURIFICATION_TOWER_3 = baseKey("solar_purification_tower_3");
