...
public class FluidPipeWood extends FluidPipe {

    public static final NamespacedKey KEY = pylonKey("fluid_pipe_wood");
    ...
    public FluidPipeWood(@NotNull PylonItemSchema schema, @NotNull ItemStack stack) {
        super(schema, stack);
    }
