...
public final class BaseItems {
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(COPPER_DUST_KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(CRUSHED_RAW_COPPER_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(GOLD_DUST_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                GOLD_DUST_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(IRON_DUST_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                IRON_DUST_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(QUARTZ_DUST_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                QUARTZ_DUST_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(DIAMOND_DUST_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                DIAMOND_DUST_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(EMERALD_DUST_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                EMERALD_DUST_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(ROCK_DUST_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                ROCK_DUST_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(SULFUR_KEY);
    }
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(SULFUR_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(GOLD_SHEET_KEY);
        Hammer.Recipe.RECIPE_TYPE.addRecipe(new Hammer.Recipe(
                GOLD_SHEET_KEY,
                new ItemStack(Material.GOLD_INGOT),
                GOLD_SHEET,
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(IRON_SHEET_KEY);
        Hammer.Recipe.RECIPE_TYPE.addRecipe(new Hammer.Recipe(
                IRON_SHEET_KEY,
                new ItemStack(Material.IRON_INGOT),
                IRON_SHEET,
    ...
    static {
        ...
        BasePages.TOOLS.addItem(Hammer.HAMMER_STONE_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(Hammer.HAMMER_IRON_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(Hammer.HAMMER_DIAMOND_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(WateringCan.KEY);
    ...
    static {
        ...
        BasePages.FOOD.addItem(MonsterJerky.KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(RAW_FERRODURALUM_KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(FERRODURALUM_INGOT_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(FERRODURALUM_SHEET_KEY);
        Hammer.Recipe.RECIPE_TYPE.addRecipe(new Hammer.Recipe(
    ...
    static {
        ...
        BasePages.TOOLS.addItem(FERRODURALUM_AXE_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(FERRODURALUM_PICKAXE_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(FERRODURALUM_SHOVEL_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(FERRODURALUM_HOE_KEY);
    ...
    static {
        ...
        BasePages.ARMOUR.addItem(FERRODURALUM_HELMET_KEY);
    ...
    static {
        ...
        BasePages.ARMOUR.addItem(FERRODURALUM_CHESTPLATE_KEY);
    ...
    static {
        ...
        BasePages.ARMOUR.addItem(FERRODURALUM_LEGGINGS_KEY);
    ...
    static {
        ...
        BasePages.ARMOUR.addItem(FERRODURALUM_BOOTS_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(COMPRESSED_WOOD_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(PORTABILITY_CATALYST_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(COMPRESSED_OBSIDIAN_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(PortableCraftingTable.KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(PortableDustbin.KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(PortableEnderChest.KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(FIBER_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(PLASTER_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(BANDAGE_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(SPLINT_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(DISINFECTANT_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(MEDKIT_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(Sprinkler.KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(LumberAxe.KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(FLOUR_KEY);
        Grindstone.Recipe.RECIPE_TYPE.addRecipe(new Grindstone.Recipe(
                FLOUR_KEY,
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(DOUGH_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(HealthTalisman.HEALTH_TALISMAN_SIMPLE_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(HealthTalisman.HEALTH_TALISMAN_ADVANCED_KEY);
    ...
    static {
        ...
        BasePages.TOOLS.addItem(HealthTalisman.HEALTH_TALISMAN_ULTIMATE_KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(SHIMMER_DUST_1_KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(SHIMMER_DUST_2_KEY);
        MixingPot.Recipe.RECIPE_TYPE.addRecipe(new MixingPot.Recipe(
                SHIMMER_DUST_2_KEY,
                Map.of(
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(EnrichedNetherrack.KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(COVALENT_BINDER_KEY);
    ...
    static {
        ...
        BasePages.RESOURCES.addItem(SHIMMER_DUST_3_KEY);
    ...
    static {
        ...
        BasePages.COMPONENTS.addItem(SHIMMER_SKULL_KEY);
        MagicAltar.Recipe.RECIPE_TYPE.addRecipe(new MagicAltar.Recipe(
                SHIMMER_SKULL_KEY,
                new ArrayList<>(Arrays.asList(
    ...
    static {
        ...
        BasePages.BUILDING.addItem(Pedestal.PEDESTAL_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(WITHER_PROOF_OBSIDIAN_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidPipe.PIPE_WOOD_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidPipe.PIPE_COPPER_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidPipe.PIPE_OBSIDIAN_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(PortableFluidTank.PORTABLE_FLUID_TANK_WOOD_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(PortableFluidTank.PORTABLE_FLUID_TANK_COPPER_KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(WaterPump.KEY);
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidValve.KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidFilter.KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidMeter.KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidPlacer.WATER_PLACER_KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidPlacer.LAVA_PLACER_KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidDrainer.WATER_DRAINER_KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidDrainer.LAVA_DRAINER_KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidVoider.FLUID_VOIDER_1_KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidVoider.FLUID_VOIDER_2_KEY);
    }
    ...
    static {
        ...
        BasePages.FLUID_MACHINES.addItem(FluidVoider.FLUID_VOIDER_3_KEY);
    }
    ...
    static {
        ...
        BasePages.BUILDING.addItem(DimensionalBarrel.KEY);
    ...
    public static final ItemStack REFRACTORY_BRICK = ItemStackBuilder.pylonItem(Material.DEEPSLATE_TILES, REFRACTORY_BRICK_KEY)
            .build();
    static {
        PylonItem.register(PylonItem.class, REFRACTORY_BRICK, BaseBlocks.REFRACTORY_BRICK_KEY);
        BasePages.SMELTING.addItem(BaseBlocks.REFRACTORY_BRICK_KEY);
    ...
    static {
        ...
        BasePages.SMELTING.addItem(SmelteryController.KEY);
    ...
    static {
        ...
        BasePages.SMELTING.addItem(SmelteryInputHatch.KEY);
    ...
    static {
        ...
        BasePages.SMELTING.addItem(SmelteryOutputHatch.KEY);
    ...
    static {
        ...
        BasePages.SMELTING.addItem(SmelteryHopper.KEY);
    ...
    static {
        ...
        BasePages.SMELTING.addItem(SmelteryCaster.KEY);
    ...
    static {
        ...
        BasePages.SMELTING.addItem(SmelteryBurner.KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(ExplosiveTarget.EXPLOSIVE_TARGET_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(ExplosiveTarget.EXPLOSIVE_TARGET_FIERY_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(ExplosiveTarget.EXPLOSIVE_TARGET_SUPER_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(ExplosiveTarget.EXPLOSIVE_TARGET_SUPER_FIERY_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(Immobilizer.KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(Elevator.ELEVATOR_1_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(Elevator.ELEVATOR_2_KEY);
    ...
    static {
        ...
        BasePages.BUILDING.addItem(Elevator.ELEVATOR_3_KEY);
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(HydraulicGrindstoneTurner.KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(HydraulicMixingAttachment.KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(HydraulicPressPiston.KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(HydraulicHammerHead.KEY);
    }

    public static final ItemStack SOLAR_LENS = ItemStackBuilder.pylonItem(Material.GLASS_PANE, BaseBlocks.SOLAR_LENS_KEY)
            .build();
    static {
        PylonItem.register(PylonItem.class, SOLAR_LENS, BaseBlocks.SOLAR_LENS_KEY);
        BasePages.HYDRAULICS.addItem(BaseBlocks.SOLAR_LENS_KEY);
    }

    public static final ItemStack PURIFICATION_TOWER_GLASS = ItemStackBuilder.pylonItem(Material.LIGHT_GRAY_STAINED_GLASS, BaseBlocks.PURIFICATION_TOWER_GLASS_KEY)
            .build();
    static {
        PylonItem.register(PylonItem.class, PURIFICATION_TOWER_GLASS, BaseBlocks.PURIFICATION_TOWER_GLASS_KEY);
        BasePages.HYDRAULICS.addItem(BaseBlocks.PURIFICATION_TOWER_GLASS_KEY);
    }

    public static final ItemStack PURIFICATION_TOWER_CAP = ItemStackBuilder.pylonItem(Material.QUARTZ_SLAB, BaseBlocks.PURIFICATION_TOWER_CAP)
            .build();
    static {
        PylonItem.register(PylonItem.class, PURIFICATION_TOWER_CAP, BaseBlocks.PURIFICATION_TOWER_CAP);
        BasePages.HYDRAULICS.addItem(BaseBlocks.PURIFICATION_TOWER_CAP);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(SolarPurificationTower.SOLAR_PURIFICATION_TOWER_1_KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(SolarPurificationTower.SOLAR_PURIFICATION_TOWER_2_KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(SolarPurificationTower.SOLAR_PURIFICATION_TOWER_3_KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(SolarPurificationTower.SOLAR_PURIFICATION_TOWER_4_KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(SolarPurificationTower.SOLAR_PURIFICATION_TOWER_5_KEY);
    }
    ...
    static {
        ...
        BasePages.HYDRAULICS.addItem(CoalFiredPurificationTower.COAL_FIRED_PURIFICATION_TOWER_KEY);
    }
