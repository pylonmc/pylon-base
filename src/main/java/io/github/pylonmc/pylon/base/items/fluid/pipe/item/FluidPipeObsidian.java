...
public class FluidPipeObsidian extends FluidPipe {

    public static final NamespacedKey KEY = pylonKey("fluid_pipe_obsidian");
    ...
    public FluidPipeObsidian(@NotNull PylonItemSchema schema, @NotNull ItemStack stack) {
        super(schema, stack);
    }
